...
Route::get('/xoacauhoi', 'XoaCauHoi@xoacauhoi')->name('xoacauhoi.check');

Route::get('/themmonhoc', 'ThemMonHoc@themmonhoc')->name('themmonhoc.check');

Route::get('/suamonhoc', 'SuaMonHoc@suamonhoc')->name('suamonhoc.check');

Route::get('/xoamonhoc', 'XoaMonHoc@xoamonhoc')->name('xoamonhoc.check');

Route::get('/caithoigian', 'CaiThoiGian@caithoigian')->name('caithoigian.check');

Route::get('/caisocauhoi', 'CaiSoCauHoi@caisocauhoi')->name('caisocauhoi.check');

Route::get('/laysocauhoi', 'LaySoCauHoi@laysocauhoi')->name('laysocauhoi.check');

Route::get('/laythoigianthi', 'LayThoiGianThi@laythoigianthi')->name('laythoigianthi.check');

Route::get('/xoathoigianthi', 'XoaThoiGianThi@xoathoigianthi')->name('xoathoigianthi.check');

Route::get('/laynhomcauhoi', 'LayNhomCauHoi@laynhomcauhoi')->name('laynhomcauhoi.check');

Route::get('/laycautruc', 'LayCauTruc@laycautruc')->name('laycautruc.check');

Route::get('/themcautruc', 'ThemCauTruc@themcautruc')->name('themcautruc.check');

Route::get('/xoacautruc', 'XoaCauTruc@xoacautruc')->name('xoacautruc.check');
