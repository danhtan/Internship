...
<body>
    ...
    <script type="text/babel">
        ...
        const reducer = (state = initState, action) => {
            switch (action.type) {
                ...
                case 'GET_TENHISTORY': {
                    ...
                    return {...state,tenhistory: action.tenhistory}
                }
                                    ...
                                    return(  
                                        ...
                                        <div key={index1} >
                                                <div className="cauhoi">
                                                  <span>Câu {index1+1}: {value.CauHoi[0].NoiDung}</span> 
                                                  <br />
                                                          <input 
                                                            type="radio" 
                                                            
                                                         />
                                                        <span id="true"> {value.Dung[0].NoiDung}</span>
                                                        <br />
                                                        <input 
                                                            type="radio" defaultChecked  
                                                            
                                                         />
                                                        <span> {value.Chon.length ? value.Chon[0].NoiDung : ''}</span>
                                                </div>
                                            </div>
        ...
        const HistoryConnected = connect( (state)=>({ show1:state.show1,diemtungmon:state.diemtungmon,tenmh:state.tenmh,idmon:state.idmon,show2:state.show2,danhsachcauhoi:state.danhsachcauhoi,tenhistory:state.tenhistory}))(History)
        ReactDOM.render(
