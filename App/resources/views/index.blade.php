...
<body>
<div >
            <h2 style="background-color: blue; color:white; width:100%;height:50px;margin-top:0px;padding-top:10px;padding-left:3px">HỆ THỐNG THI TRẮC NGHIỆM TRỰC TUYẾN</h2>
        </div>
    <div class="dangnhap">
